...
<img width="300" height="150" alt="chatcode title" src="https://github.com/user-attachments/assets/25660c64-7919-4166-a2fc-92cfc7558da3" />

[Support](https://lnkfi.re/platcode) | [Star](https://github.com/pltcd/chatcode)
</div>
...
- Select font look and size of your choice (the defaults are ***Open Sans*** size ***24***)
- (*Optional*) you can set up a background gradient, for those cases if you really want chat box to be readable on any background
- If you would like to make any changes later, click ***Interact →*** right-click ***→ Settings***.

<img width="1720" height="1080" alt="widget setup 2" src="https://github.com/user-attachments/assets/73f61606-0fa9-4569-92a3-a59e037e6421" />
